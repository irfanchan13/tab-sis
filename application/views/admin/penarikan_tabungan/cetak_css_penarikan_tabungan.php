...
<head>
    ...
    <title>Cetak Semua Penarikan Tabungan</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="container-fluid pt-2 border">
        ...
        <table class="table table-borderless">
            <tr class="text-center">
                ...
                <th width="250">
                    <h5 class="border pt-2 pl-2 pr-2 pb-2">Laporan Semua Penarikan Tabungan</h5>
                </th>
            </tr>
        </table>
        <hr class="mb-4">
        <table class="table-bordered mb-4" width="100%" style="padding-left: 5px; padding-right: 5px;">
            ...
            <?php endforeach; ?>
            <tr>
                <th class="text-center" colspan="6">Total Semua Penarikan Tabungan</th>
