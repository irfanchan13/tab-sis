                ...
                <div class="col-lg-12">
                  <div class="p-2">
                    <div class="text-center">
                      ...
                      <h2 class="text-gray-900 mb-0">BANK MINI </h2>
                      <h3 class="text-gray-900 mb-0">GEMA MENABUNG </h3>
                      <hr class="mb-3 mt-0">
                    ...
                    <form class="user mt-3" method="post" action="<?= base_url(); ?>login-user">
                      ...
                      <center><small><i><?= $pengaturan['jalan'] . ' Rt. ' . $pengaturan['rt'] . ' Rw. ' . $pengaturan['rw'] . ' Kel. ' . $pengaturan['kelurahan'] . ' Kec. ' . $pengaturan['kecamatan'] . ' ' . $pengaturan['kabupaten_kota'] . ' - ' . $pengaturan['provinsi']; ?></i></small><br>
                        <small><a href="<?= $pengaturan['website']; ?>"><?= $pengaturan['website']; ?></a></small>
                      </center>
...
<footer class="sticky-footer bg-white">
  <div class="container my-auto">
    <div class="copyright text-center my-auto">
      <span>Copyright &copy; Tim IT SUPPORT</span>
    </div>
  </div>
</footer>
<!-- End of Footer -->
